...
#linux
# compile:
# 	g++ -c main.cpp ./src/*.cpp ./src/states/*.cpp ./src/entities/*.cpp -I./headers -I./headers/states -I/usr/include/SFML -DSFML_STATIC
# link:
...
#windows
compile:
	g++ -c main.cpp ./src/*.cpp ./src/states/*.cpp ./src/entities/*.cpp -I./headers -I./headers/states -I./headers/entities -IC:\SFML\include -DSFML_STATIC
link:
